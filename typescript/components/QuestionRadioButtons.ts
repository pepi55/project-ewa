export class QuestionRadioButtos {
    ...
    public getView(screenNumber: number) {
        ...
        <input type="radio" id="option-${screenNumber}-2" class="mdl-radio__button" name="options-${screenNumber}" value="2">
        ...
        <input type="radio" id="option-${screenNumber}-3" class="mdl-radio__button" name="options-${screenNumber}" value="3">
        ...
        <input type="radio" id="option-${screenNumber}-4" class="mdl-radio__button" name="options-${screenNumber}" value="4">
        ...
        <input type="radio" id="option-${screenNumber}-5" class="mdl-radio__button" name="options-${screenNumber}" value="5">
