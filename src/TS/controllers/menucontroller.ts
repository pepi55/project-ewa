...
export class MenuController extends Controller {
    ...
    protected setup(): void {
        ...
        profileItem.setOnClick((e: any) => {window.location.href = "/views/profile.html";})
        menuItem.setOnClick((e: any) => {window.location.href = "/views/menu.html";})
        coursesItem.setOnClick((e: any) => {window.location.href = "/views/userCourses.html";})
        adminItem.setOnClick((e: any) => {window.location.href = "/views/adminCourses.html";})
